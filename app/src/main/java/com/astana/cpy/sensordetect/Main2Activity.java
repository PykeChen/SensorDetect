...
public class Main2Activity extends AppCompatActivity implements SensorEventListener {
    ...
    protected void onResume() {
        ...
        // 为特殊运动传感器注册监听器
        mSensorManager.registerListener(this, mSensorManager.getDefaultSensor(Sensor.TYPE_SIGNIFICANT_MOTION), SensorManager.SENSOR_DELAY_GAME);
        // 为精制检测传感器注册监听器
        mSensorManager.registerListener(this, mSensorManager.getDefaultSensor(Sensor.TYPE_STATIONARY_DETECT), SensorManager.SENSOR_DELAY_GAME);
    }
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (type){
            ...
            case Sensor.TYPE_STATIONARY_DETECT:
                ...
                sb.append(", ").append(values[1]);
                sb.append(", ").append(values[2]);
                mTxtValue11.setText(sb.toString());
                break;
        }
    }
